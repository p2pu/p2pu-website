...
function prepareYoumax() {
	...
	youmaxUser = 'UCJH3nTAgEAGljjTB5B8PjFw';
	...
	var apiProfileURL = "http://gdata.youtube.com/feeds/api/channels/" + youmaxUser + "?v=2&alt=json";
...
function showInfo(response) {
	//console.log(response.entry.media$thumbnail[0].url);

	var channelName = 'P2PU';//response.entry.yt$username.display;
	var channelPic = response.entry.media$thumbnail[0].url;
	var channelSubscribers = response.entry.yt$channelStatistics.subscriberCount;
	var channelViews = 0;//response.entry.yt$statistics.totalUploadViews;
	...
	$('#youmax-header').append('<script src="https://apis.google.com/js/platform.js"></script><div class="pull-left g-ytsubscribe" data-channelid="UCJH3nTAgEAGljjTB5B8PjFw" data-layout="default" data-count="default"></div>');
