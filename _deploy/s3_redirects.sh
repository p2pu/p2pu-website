...
do
    ...
    aws s3api put-object --output text --bucket $S3_BUCKET --key $url/index.html --website-redirect-location=/en/$url/ --acl public-read --storage-class REDUCED_REDUNDANCY
done
